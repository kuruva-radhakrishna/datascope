...
// Vercel serverless wrapper — thin adapter over the shared router so the
// exact same backend logic runs on Vercel and in the Docker image.

const { route } = require('../backend/lib/handlers.js');
